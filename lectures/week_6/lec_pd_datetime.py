...
#repr() returns a string representing how the instance could be constructed
...
date  = dt.datetime(year=2020, month=12, day=31, hour=12)
...
# Pease print x as a string in the following format:
# 'Sunday of week number 53 of the year 2023'

result = x.strftime('%A of week number %W of the year %Y')
#print(result)
...
#print(prc.index)  # RangeIndex(start=0, stop=3123, step=1)
#
...
#   In‑Class Exercise 2
# ----------------------------------------------------------------------------
# What is the value of "Adj Close" for the 15th trading day in March 2019 in the prc dataframe?
result = prc.loc['2019-03'].iloc[14]['Adj Close']
#print(result)
